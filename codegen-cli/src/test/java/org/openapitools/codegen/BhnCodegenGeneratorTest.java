 ...
 * 1) Set a break point in BhnCodegenGenerator.java in the postProcessOperationsWithModels() method.
 * 2) To launch this test in Eclipse: right-click | Debug As | JUnit Test
 *
 */
public class BhnCodegenGeneratorTest {
  ...
  public void launchCodeGenerator() {
    ...
    final CodegenConfigurator configurator = new InCustomCodegenConfigurator()
              .setGeneratorName("bhn-codegen") // use this codegen library
              ...
              .setOutputDir("out/bhn-codegen"); // output directory
